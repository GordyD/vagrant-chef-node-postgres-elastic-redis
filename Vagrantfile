...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "gordon-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tripjoin"
  #   chef.validation_client_name = "tripjoin-validator"
  #   chef.validation_key_path = ".chef/tripjoin-validator.pem"
  # end
end
